...
public class EmotionUtils implements Serializable {
	...
	public static SparseIntArray intArray = new SparseIntArray(200);
	public static SparseBooleanArray booleanArray = new SparseBooleanArray(100);
	public static SparseArray<String> stringSparseArray = new SparseArray<>();
	static {
